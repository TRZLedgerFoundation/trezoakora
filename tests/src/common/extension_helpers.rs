...
impl ExtensionHelpers {
    ...
    pub async fn create_token_account_with_memo_transfer(
        ...
        let initialize_memo_transfer_instruction =
            tpl_token_2022_interface::extension::memo_transfer::instruction::enable_required_transfer_memos(
                &tpl_token_2022_interface::id(),
                &token_account_keypair.pubkey(),
                &owner.pubkey(),
                &[&owner.pubkey()],
    ...
    async fn initialize_extra_account_meta_list(
        ...
        initialize_instruction
            .accounts
            .push(AccountMeta::new_readonly(trezoa_system_interface::program::id(), false));
